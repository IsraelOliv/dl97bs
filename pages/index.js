...
export default function Home() {
 ...
 A sua privacidade é importante para nós. É política do DeadLine1997 respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site DeadLine1997, e outros sites que possuímos e operamos.
 ...
 <br /><br /> O uso continuado de nosso site será considerado como aceitação de nossas práticas em torno de privacidade e informações pessoais. 
 ...
 <br /><br />
     O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o DeadLine1997 oferece no site e com caráter enunciativo, mas não limitativo:<br />
       A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;<br />
        B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou casas de apostas online, jogos de sorte e azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos; <br />
        C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do DeadLine1997, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.<br /><br />
